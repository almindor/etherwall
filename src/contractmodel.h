...
namespace Etherwall {
    ...
    public:
        ...
        Q_INVOKABLE const QStringList getArguments(int index, const QString& functionName) const;
        Q_INVOKABLE const QString encodeCall(int index, const QString& functionName, const QVariantList& params) const;
    private:
        void reload();
